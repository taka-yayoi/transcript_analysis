# 誰の発言が誰の感情を動かしたか？会話の影響力を可視化する感情分析パイプライン

会議やインタビューの会話から、**誰の発言が誰の感情にどう影響したか**を明らかにするDatabricks Notebookです。Claude Sonnet 4.5を使用した高精度な感情分析により、発話者間の影響関係を定量化し、会話のダイナミクスを可視化します。
